...
set sql(17) "CREATE INDEX REGION_PK ON REGION (R_REGIONKEY)"
set sql(18) "CREATE INDEX NATION_PK ON NATION (N_NATIONKEY)"
set sql(19) "CREATE INDEX SUPPLIER_PK ON SUPPLIER (S_SUPPKEY)"
set sql(20) "CREATE INDEX PARTSUPP_PK ON PARTSUPP (PS_PARTKEY,PS_SUPPKEY)"
set sql(21) "CREATE INDEX PART_PK ON PART (P_PARTKEY)"
set sql(22) "CREATE INDEX ORDERS_PK ON ORDERS (O_ORDERKEY)"
set sql(23) "CREATE INDEX LINEITEM_PK ON LINEITEM (L_LINENUMBER, L_ORDERKEY)"
set sql(24) "CREATE INDEX CUSTOMER_PK ON CUSTOMER (C_CUSTKEY)"
	}
